...
class P2PConnection {
    ...
    enableEventSharing() {
        ...
        this.socket1.on('drop-successful', (data) => {
            this.socket1.broadcast.to(this.socket2.id).emit('opponent-turn', data);
        ...
        this.socket2.on('drop-successful', (data) => {
            this.socket2.broadcast.to(this.socket1.id).emit('opponent-turn', data);
